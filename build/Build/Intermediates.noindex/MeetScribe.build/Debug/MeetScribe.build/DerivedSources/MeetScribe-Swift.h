...
#ifndef MEETSCRIBE_SWIFT_H
#define MEETSCRIBE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MeetScribe",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10MeetScribe21MeetScribeAppDelegate")
@interface MeetScribeAppDelegate : NSObject <NSApplicationDelegate>
- (void)applicationDidFinishLaunching:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10MeetScribe21MenuBarHostController")
@interface MenuBarHostController : NSObject
